...
return [
    ...
    'showing-all-projects'     => ':client - Projects',
    'users-menu-alt'        => 'Show Users Management Menu',
    'create-new-client'       => 'Create New Client',
    'show-archived-clients'    => 'Show Archived Clients',
    ...
    'buttons' => [
        ...
        'back-to-clients'  => 'Back  <span class="hidden-xs">to Clients</span>',
        'back-to-projects'  => 'Back  <span class="hidden-xs">to Projects</span>',
    ...
    'messages' => [
        ...
        'delete-success'         => 'Successfully archived the user!',
