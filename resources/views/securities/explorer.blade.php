...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        function updateRelatedSecurities() {
            // Clear related securities tables
            $('#related-securities-container').html('');
            // Get updated related securities data
